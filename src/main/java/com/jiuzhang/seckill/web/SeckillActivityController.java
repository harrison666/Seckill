...
public class SeckillActivityController {
    ...
    public String itemPage(Map<String, Object> resultMap, @PathVariable long seckillActivityId) {
        ...
        String seckillActivitityInfo = redisService.getValue("seckillActivitity:" + seckillActivityId);
        if (StringUtils.isNotEmpty(seckillActivitityInfo)) {
            log.info("redis缓存数据：" + seckillActivitityInfo);
            seckillActivity = JSON.parseObject(seckillActivitityInfo, SeckillActivity.class);
        } else {
